        ...
        <div class="edit-info" style="margin:40px 0 60px 0">
            <a-form>
                <a-form-item label="邮箱" :label-col="{ span: 2 }" :wrapper-col="{ span: 9 }">
                    <a-input><a-icon slot="suffix" type="mail" allowClear/></a-input>
                </a-form-item>
                <a-form-item label="手机号" :label-col="{ span: 2 }" :wrapper-col="{ span: 9 }">
                    <a-input><a-icon slot="suffix" type="phone" allowClear/></a-input>
                </a-form-item>
                <a-form-item label="职位" :label-col="{ span: 2 }" :wrapper-col="{ span: 9 }">
                    <a-input><a-icon slot="suffix" type="idcard" allowClear/></a-input>
                </a-form-item>
