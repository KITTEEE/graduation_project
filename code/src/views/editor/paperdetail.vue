    ...
    methods: {
        ...
        pass() {
            if (this.detailInfo.state == 1) {
                ...
                this.changeState(this.pid, parseInt(this.detailInfo.state) + 1);
            }
        },
        returnBack() {
            if (this.remarkText == '') {
            ...
            this.changeBack(this.pid, this.detailInfo.state, this.remarkText);
        },
        showModal() {
        ...
        changeBack(id, state, remark = '') {
            this.$axios
                .post(`${this.$backEnd}/api/paper/returnBack`, { pid: id, laststate: state, remark })
                .then((res) => {
                    this.$message.success(res.data.message);
                    this.back();
                })
